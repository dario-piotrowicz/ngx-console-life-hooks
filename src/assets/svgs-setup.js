const svgDefinitions = document.createElementNS(
  "http://www.w3.org/2000/svg",
  "svg"
);

svgDefinitions.setAttribute("aria-hidden", "true");
svgDefinitions.setAttribute(
  "style",
  "position: absolute; width: 0; height: 0; overflow: hidden"
);
svgDefinitions.setAttribute("version", "1.1");
svgDefinitions.setAttribute("xmlns", "http://www.w3.org/2000/svg");
svgDefinitions.setAttribute("xmlns:xlink", "http://www.w3.org/1999/xlink");

svgDefinitions.innerHTML = `
<defs>

    <symbol id="icon-star" viewBox="0 0 35 35">
      <path
    ...
    <symbol id="angular-no-a" viewBox="0 0 250 250">
      <style type="text/css">
        .st0 {
          fill: #dd0031;
        }
    ...
    <symbol id="angular-logo" viewBox="0 0 250 250">
      <style type="text/css">
        .st0 {
          fill: #dd0031;
        }
    ...
    <symbol id="react-logo" viewBox="0 0 841.9 595.3">
      <g>
        <path
          fill="#61DAFB"
    ...
    <symbol id="vue-logo" viewBox="0 0 261.76 226.69">
...
document.head.appendChild(svgDefinitions);
