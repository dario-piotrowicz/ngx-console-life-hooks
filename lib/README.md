...
| `colorScheme`       | color scheme for the logs                                                                                  | string containing one of the [available color schemes](https://ngx-console-life-hooks.netlify.app/color-schemes)  | `'default'`   |
| `customColors`      | custom set of colors for the logs                                                                          | object representing the colors to use, [read more here](https://ngx-console-life-hooks.netlify.app/custom-colors) | `null`        |
